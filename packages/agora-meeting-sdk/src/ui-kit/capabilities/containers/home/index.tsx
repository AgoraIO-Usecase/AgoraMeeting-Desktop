...
import { LanguageEnum, transI18n } from '~ui-kit';
...
export interface MettingHomeProps extends BaseProps {
  ...
  onChangeLanguage?: (v: LanguageEnum) => void;
  join?: () => void;
}

export const MettingHome: FC<MettingHomeProps> = observer(
  ({
        ...
        <div className="login">
          ...
          <form className="login__center">
            ...
            <Input
              ...
              onChange={(e) =>
                handleRoomPasswordChange(e.target.value)
              }></Input>
            <Input
              style={{ height: '40px', marginTop: '20px' }}
